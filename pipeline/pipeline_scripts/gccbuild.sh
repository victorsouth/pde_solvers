...
cmake .. -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-w -Wno-#pragma-messages" -DPDE_SOLVERS_BUILD_TESTS=ON -DCMAKE_INSTALL_PREFIX=../Libs/GCC > ${LOG_DIR}/pde_solvers_build.log 2>&1

...
* [Влияние профиля трубопровода на квазистационарный гидравлический расчёт](#Влияние-профиля-трубопровода-на-квазистационарный-гидравлический-расчёт)
  * [Доказательство влияния профиля на квазистационарный гидравлический расчёт](#Доказательство-влияния-профиля-на-квазистационарный-гидравлический-расчёт)
...
В стационарной модели для гидравлического расчёта (решения задачи PQ) профиль трубопровода (I) можно заменить прямой, используя только начальную и конечную точки (II). Справедлив такой шаг в связи с тем, что реология по всей длине трубопровода одинакова.

![Замена профиля прямой линии][profile]

[profile]: images/two_profiles.png "Замена профиля прямой линией"  

<div align = "center">
</center><b>Замена профиля прямой линией</b></center>
</div>
<br>

В квазистационарной же модели так сделать нельзя, так как плотность и вязкоть в каждой точке профиля в общем случае отличается, что оказывает влияние на гидравлический расчёт

### Доказательство влияния профиля на квазистационарный гидравлический расчёт

Чтобы доказать, что в квазистационарной модели профиль нельзя заменить прямой, проведём эксперимент - смоделируем работу трубопровода аналогично пункту [Модель на методе характеристик с переменным временным шагом](#Модель-на-методе-характеристик-с-переменным-временным-шагом)

В результате получим, что до момента начала замещения партии и после того, как партия полностью вытяснит начальную, модель будет аналогична стационарной модели, поэтому разность давлений в конце трубопроаода будет равна нулю. При одновременном нахождении двух партий в трубе давления будут отличаться.

![Эксперимент по влиянию профиля на квазистационарный гидравлический расчёт][prof_exp]

[prof_exp]: images/prof_experiment.png "Эксперимент по влиянию профиля на квазистационарный гидравлический расчёт"  

<div align = "center">
</center><b>Эксперимент по влиянию профиля на квазистационарный гидравлический расчёт</b></center>
</div>
<br>
...
Как видно из графика, давления в конце трубопровода двух опытов совпадают до начала вытеснения и после его завершения и отличаются при одновременном нахождении двух партий в трубе, что подтверждает влияние профиля при изменении реологии в квазистационарной модели

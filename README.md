...
Для моделирования партий в условиях хаотической многопартийности нужен численный метод, имеющий высокую точность и устойчивость. Низкая точность проявляется в виде проблемы численной диффузии. Низкая устойчивость проявляется в виде осцилляций (затухающих или незатухающих).

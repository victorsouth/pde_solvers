...
Чтобы доказать, что в квазистационарной модели профиль нельзя заменить прямой, проведём эксперимент - смоделируем работу трубопровода аналогично пункту [Исследование возникновения ступенчатой партии при идеальных условиях](#Исследование-возникновения-ступенчатой-партии-при-идеальных-условиях)

В результате получим, что до момента начала замещения партии и после того, как партия полностью вытяснит начальную, модель будет аналогична стационарной модели, поэтому разность давлений в конце трубопроаода будет равная нулю. При одновременном нахождении двух партий в трубе давления будут отличаться.

![Эксперимент по влиянию профиля на квазистационарный гидравлический расчёт][prof_exp]

[prof_exp]: images/profile_experiment.png "Эксперимент по влиянию профиля на квазистационарный гидравлический расчёт"  
...
Исходя из графика разницы давлений в конце трубопровода влияние профиля при изменении реологии в трубопроводе подтвердилось

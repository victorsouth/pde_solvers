...
![Временные ряды и временна секта численного метода][timeseries_schema]

[timeseries_schema]: images/timeseries_schema.png "Временные ряды и временна секта численного метода"  

<div align = "center">
</center><b>Временные ряды и временна секта численного метода</b></center>
</div>
<br>

...
* [Расчётная задача гидравлического изотермического квазистационарного расчета](#Расчётная-задача-гидравлического-изотермического-квазистационарного-расчета)
  * [Проблемено-ориентированные абстракции](#Проблемено-ориентированные-абстракции)
...
### Проблемено-ориентированные абстракции
...
Класс `isothermal_quasistatic_task_t`принимает при инициализации в качестве шаблонных аргументов следующие параметры:

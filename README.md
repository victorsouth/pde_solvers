...
Как видно из графика, давления в конце трубопровода двух опытов совпадают до начала вытеснения и после его завершения, что подтверждает влияние профиля при изменении реологии в квазистационарной модели

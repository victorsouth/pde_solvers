...
#path = 'C:/Users/Nikita Andrianov/Documents/GitHub/pde_solvers/research_out/QSM_models/NonisothermalQuasistaticModelWithRealData/moc_kt0'
path = 'C:/Users/Nikita Andrianov/Documents/GitHub/pde_solvers/research_out/QSM_models/NonisothermalQuasistaticModelWithRealData_Pressure/QuasiStationaryFullReology_Pressure'
...
while True:
    ...
    def init_func():
        for i in range(len(axes)):
            ...
            print(f"{parametersNames[i]}: min = {paramData.min():.4f}, max = {paramData.max():.4f}")
